...
import { Home, Book, User, Settings, LogOut, MessageSquare, Star, Sparkles, PieChart, Users, Target, Calendar, Award, Plus, UserPlus, BarChart2 } from "lucide-react";
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <GoalTrackingDialog 
        ...
        goal={selectedQuest}
        onUpdateGoal={handleUpdateQuest}
      />
    </div>
  );
}
