  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-white rounded-lg border p-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Book On-Demand Session with {teacher.name}</h2>
        
        <Tabs defaultValue="calendar" className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="calendar">Available Times</TabsTrigger>
          ...
          <TabsContent value="classes">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <h3 className="text-xl font-semibold">Regular Classes by {teacher.name}</h3>
