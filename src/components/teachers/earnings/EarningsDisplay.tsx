...
const EarningsDisplay = ({ earnings }: EarningsDisplayProps) => {
  return (
    <div className="bg-blue-50 p-4 md:p-6 rounded-lg">
      <h3 className="text-lg md:text-xl font-semibold text-kidato-purple mb-4 md:mb-6 flex items-center">
        <DollarSign className="mr-2 h-4 w-4 md:h-5 md:w-5 text-kidato-purple" />
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4">
        <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
          ...
          <div className="flex items-center">
            <span className="text-base md:text-xl font-bold text-kidato-purple truncate">{earnings.daily}</span>
          </div>
        </div>
        ...
        <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
          ...
          <div className="flex items-center">
            <span className="text-base md:text-xl font-bold text-kidato-purple truncate">{earnings.weekly}</span>
          </div>
        </div>
        ...
        <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
          ...
          <div className="flex items-center">
            <span className="text-base md:text-xl font-bold text-kidato-purple truncate">{earnings.monthly}</span>
          </div>
        </div>
        ...
        <div className="bg-white p-3 md:p-4 rounded-lg shadow-sm">
          ...
          <div className="flex items-center">
            <span className="text-base md:text-xl font-bold text-kidato-purple truncate">{earnings.yearly}</span>
          </div>
        </div>
      </div>
