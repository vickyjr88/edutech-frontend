        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-kidato-purple hover:text-kidato-dark-blue">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/become-a-tutor" className="text-gray-600 hover:text-kidato-purple">
                  Become a Tutor
                </Link>
              </li>
              <li>
                <Link to="/for-parents" className="text-gray-600 hover:text-kidato-purple">
                  For Parents
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/careers" className="text-gray-600 hover:text-kidato-purple">
                  Careers
                </Link>
              </li>
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-kidato-purple">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/privacy" className="text-gray-600 hover:text-kidato-purple">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-600 hover:text-kidato-purple">
                  Terms of Service
                </Link>
              </li>
            </ul>
