  ...
  return (
    ...
    >
      <Avatar className="h-10 w-10 flex-shrink-0">
        <AvatarFallback className={`${getAvatarColor(message.role)} text-white`}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline">
          <h4 className="font-medium text-sm">{message.author}</h4>
          <span className={`ml-2 text-xs font-medium ${getRoleColor(message.role)}`}>
            {message.role}
          </span>
