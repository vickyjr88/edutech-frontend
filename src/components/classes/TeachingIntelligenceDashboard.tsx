...
const TeachingIntelligenceDashboard: React.FC<TeachingIntelligenceDashboardProps> = ({
  ...
  const getPerformanceInsights = () => {
    const insights = [
      ...
      },
      {
        ...
        description: 'Quizzes on Wednesdays result in 15% better performance',
        impact: 'medium',
        confidence: 72,
        trend: 'up'
      },
      {
        ...
        description: 'Weekend assignments have 20% lower completion rates',
        impact: 'medium',
        confidence: 91,
        trend: 'down'
      }
  ...
  const getStudentReadinessPredictions = () => {
    return classes.map(cls => ({
      ...
      strugglingStudents: cls.studentInsights.strugglingStudents,
      nextChallenge: cls.nextLesson?.topic || 'Upcoming Assessment',
      recommendations: [
        'Consider review session for struggling students',
