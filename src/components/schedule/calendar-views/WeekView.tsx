...
export function WeekView({ date, events, onDateSelect, onEventClick }: WeekViewProps) {
              ...
              {day.events.map((event, eventIdx) => {
                ...
                return (
                  <div
                    key={eventIdx}
                    className={cn(
                      "absolute left-1 right-1 rounded p-1.5 text-xs cursor-pointer hover:brightness-95",
