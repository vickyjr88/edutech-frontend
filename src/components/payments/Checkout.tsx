...
const CheckoutFlow = ({ onClose }: CheckoutFlowProps) => {
  const [step, setStep] = useState(1);
  // Mock logged-in student profile data
  ...
  const courseData = {
    ...
    enrollmentDeadline: "July 26, 2025",
    spotsRemaining: 28,
    duration: "12 weeks",
    description: "This course introduces students to fundamental mathematical concepts including algebraic expressions, geometric shapes, and statistical analysis."
  };
