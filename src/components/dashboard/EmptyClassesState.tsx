...
const EmptyClassesState = () => {
  return (
    <div className="text-center py-12 bg-kidato-light-blue rounded-lg">
      <div className="w-16 h-16 bg-kidato-purple rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <Button asChild className="bg-kidato-purple hover:bg-kidato-purple/90">
